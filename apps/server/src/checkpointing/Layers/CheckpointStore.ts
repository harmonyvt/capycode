  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "capycode-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "Capycode",
              GIT_AUTHOR_EMAIL: "capycode@users.noreply.github.com",
              GIT_COMMITTER_NAME: "Capycode",
              GIT_COMMITTER_EMAIL: "capycode@users.noreply.github.com",
            };
            ...
            const message = `capycode checkpoint ref=${input.checkpointRef}`;
